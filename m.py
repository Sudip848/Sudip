...
bot = telebot.TeleBot('7545910220:AAFlFoD3Cv31EIv2B52HDlyRk8M9VQqkLk4')
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @Mk_Manik78 ❄."
        bot.reply_to(message, response)
...
Buy From :- @Mk_Manik78
Official Channel :- https://t.me/opmk787
'''
...
def welcome_start(message):
    ...
    response = f'''❄️ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 🙏MANIK ᴅᴅᴏs ʙᴏᴛ, {user_name}! ᴛʜɪs ɪs ʜɪɢʜ ǫᴜᴀʟɪᴛʏ sᴇʀᴠᴇʀ ʙᴀsᴇᴅ ᴅᴅᴏs. ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss.
...
3. MAKE SURE YOU JOINED https://t.me/opmk787 OTHERWISE NOT WORK
